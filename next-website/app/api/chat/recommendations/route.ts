...
const recommendationSchema = z.object({
    recommendations: z.array(
        z.object({
            ...
            recommendation: z
                .string()
                .describe("Short UI display label (3-5 words). Must use 'my' (e.g., 'Ask about my career path'). NEVER use proper names like 'KJ'."),
            message: z
                .string()
                .describe("Full prompt addressed to 'you'. MUST directly expand on the exact topic in 'recommendation' with 100% semantic alignment (e.g., 'Give me your career path ever since you started programming'). NEVER use proper names like 'KJ'."),
        })
    ).min(3).max(4),
});
