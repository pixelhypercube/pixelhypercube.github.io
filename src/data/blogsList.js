    ...
    },
    {
        ...
        "htmlContent":(
            <div className={styles.blogContainer}>
                ...
                <p>However, if you aspire to get a spot into a local university from Polytechnic, it is statistically more difficult for Polytechnic students to get in, especially in <strong>competitive courses</strong> like Computer Science and Medicine. <strong>GPA is king</strong> in university admissions and having a score of at least <strong>~3.5</strong> would comfortably put you into a university course, and minimally <strong>~3.8x</strong> if you are applying for more competitive courses, especially in the Big 3 (NUS, NTU & SMU). That said, other factors, such as extracurriculars, hackathons, and even prior work experience, are also considered in the application process. Still, GPA remains the most important factor as of now.</p>
