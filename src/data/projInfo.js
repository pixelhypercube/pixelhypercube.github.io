...
var projInfo = [
    {
        ...
        "description": "Architected a robust internship management system built on strict OOP principles and SOLID design patterns to ensure code modularity. The application features a custom Java CLI with secure role-based authentication and persistent data serialization to handle complex user states. This project was developed for the SC2002 - Object Oriented Design and Programming module to demonstrate advanced software architecture concepts.",
        "brief_description": "Architected an internship management system using strict OOP principles (SOLID), featuring role-based authentication and persistent data handling via Java CLI.",
    ...
    },
    {
        ...
        "gh_link": "https://github.com/pixelhypercube/Astertris",
        "tech_stack":[
            "Java"
        ]
    },
