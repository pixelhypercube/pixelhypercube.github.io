...
var projInfo = [
    ...
    },
    {
        ...
        "brief_description": "A replica of a minigame from Super Mario 64 DS!",
    ...
    },
    {
        ...
        "title_jp": "円周率近似",
        "title_zh": "π 值近似模拟器",
        "description":"Simulates one of the methods of estimating the mathematical constant pi (π). Uses the ratio between the circles that are inside the big circle (red circles) and those that are outside the circle (blue circle) that will eventually be estimated to the value of π (pi). Inspired by the Coding Train's simulation of this fun way of calculating pi (π)!",
