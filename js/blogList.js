var blogList = [
    ...
    },
    {
        ...
        "duration":3,
        "htmlContent":`
            <h5>How joining a running CCA helped me with running!</h5>
            <p>I have been running as a hobby for about 6 years, but my progress plateaued - my pace stayed roughly the same over the years, and my heart rate remained relatively high. However, things have changed when I stepped outside my comfort zone to join my hall&#039;s Road Relay CCA, despite not knowing anyone in my hall before this (as I didn&#039;t join my hall&#039;s orientation due to National Service).</p>
            <p>I was hoping they had a running CCA. And there was no surprise that they did, when one of the members approached me and asked if I was interested in running. As a person who typically does long-distance runs (≥5 km per run), I was open to their training regimen, which focused on speed workouts and interval training, usually covering distances in the middle range (~1.6–5 km). I didn&#039;t hesitate - I happily signed up for the CCA.</p>
            <p>Despite not having a lot of prior experience with training for running, I was surprisingly competent enough to keep up with their training regimen. As the training regimen mainly consisted of speed workouts and interval training, it was undoubtedly not easy for me to feel at ease during my runs. It was nothing like how I felt during my typical long runs - usually calm with strong hints of exhaustion 😪. Every time I suffered during the process, the stronger I became, and surprisingly, I felt a rush of dopamine right after finishing my last set of fast runs. Even though I was busy adjusting to university life, making time for training kept me grounded and motivated. Additionally, I totally didn&#039;t expect to break several personal bests during their training - 9:06 for 2.4 km and 21:12 for 5 km.</p>
            <p>Because of my competence, I was one of the few people selected to take part in this year&#039;s Inter-Hall Olympiad Games for Road Relay, which felt like a huge milestone in my running journey. Being part of the team not only pushed me to improve physically but also gave me a sense of belonging in my hall community. I&#039;m excited to continue this journey and see where it takes me next! As the competition was held late in the morning, the weather was much worse than ideal - the sun was glaring down on the track, and the temperature felt blazing. Despite this, I was determined to try my best to represent my hall proudly. However, I felt a wave of anxiousness sweep inside of me as it was my very first time in my life that I was representing my school in some way. Additionally, I felt like my performance was much worse than I expected - 10:30 for 2.5 km (I was expecting to run under 10 minutes), because the sun was strong enough to penetrate through my shoes. Despite this, I am grateful that my team managed to clinch 1st Runner-Up, which is also the very first time my hall has received a medal for Road Relay!</p>
            <div class="d-flex">
                <div class="row">
                    ...
                    <figure class="col-md-6 col-12">
                        ...
                        <figcaption style="font-size:14px">My IHG Medal! 🥈</figcaption>
                    </figure>
                </div>
            </div>
            <p>Looking back, I felt like joining a running CCA was one of the best decisions I made to improve my running stamina - I was surrounded by people who shared the same experience as me and were willing to experience of hardships of training along together. The fact that I was surrounded by people who not only had similar interests, but they also motivated me to reach greater levels. Therefore, I highly recommend that you step outside your comfort zone to join a club that motivates you to become better at something you love to do.</p>
        `
    }
];